...
class SQLRepository:
    def __init__(self, db_name=settings.db_name):
        ...
        self.connection = sqlite3.connect(database=db_name, check_same_thread=False)
    ...
    def read_table(self, table_name, limit=None):
        ...
        sql = f'SELECT * FROM "{table_name}" LIMIT {limit}' if limit else f'SELECT * FROM "{table_name}"'
